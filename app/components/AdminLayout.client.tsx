...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      {/* Sidebar */}
      <div className={`bg-gray-900 text-white w-64 min-h-screen p-4 ${isSidebarOpen ? 'block' : 'hidden'} lg:block fixed lg:relative z-30`}>
